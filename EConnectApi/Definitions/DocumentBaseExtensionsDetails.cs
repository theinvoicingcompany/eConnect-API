...
{
    public class DocumentBaseExtensionsDetails : DocumentBaseExtensions, IDocumentDetails, IEquatable<DocumentBaseExtensionsDetails>
    {
        ...
        #region equality
        public bool Equals(DocumentBaseExtensionsDetails other)
        {
            if (other == null)
                return false;

            if (!(this as DocumentBaseExtensions).Equals(other))
                return false;
        ...
        public override bool Equals(object obj)
        {
            ...
            return Equals(obj as DocumentBaseExtensionsDetails);
        }
        #endregion
    }
}